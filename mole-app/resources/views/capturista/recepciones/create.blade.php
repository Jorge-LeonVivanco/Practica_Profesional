...
<div class="container" style="max-width: 1140px; padding: 1.5rem;">
    ...
    <form action="{{ route('capturista.recepciones.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="id_ingrediente" id="id_ingrediente" class="form-select form-select-sm" required>
                    ...
                    @foreach(App\Models\Ingrediente::where('activo',1)->get() as $ingrediente)
                        <option 
        ...
        <div class="col-md-4">
            <label class="form-label">Fecha de Ingreso al Inventario</label>
            <input type="date" name="fecha_ingreso_inventario" class="form-control form-control-sm" required>
        </div>
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="temperatura_recomendada" step="0.1" class="form-control form-control-sm">
            </div>
            ...
            <div class="col-md-4">
                <label class="form-label">Certificado de Calidad (PDF / Imagen)</label>
                <input type="file" name="certificado_calidad" class="form-control form-control-sm" accept=".pdf,.jpg,.jpeg,.png">
            </div>
...
<!-- Script para autocompletar unidad de medida -->
<script>
